...
var connectionString = builder.Configuration.GetConnectionString("ApplicationDbContexConnection") ?? throw new InvalidOperationException("Connection string 'ApplicationDbContexConnection' not found.");
